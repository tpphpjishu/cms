...
(function (factory) {
    ...
    var Renderer = function () {
        ...
        tplToolbarInfo = {
            ...
            bold: function (lang) {
                return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.font.bold + '" data-shortcut="Ctrl+B" data-mac-shortcut="鈱�+B" data-event="bold" tabindex="-1"><i class="fa fa-bold icon-bold"></i></button>';
            },
            italic: function (lang) {
                return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.font.italic + '" data-shortcut="Ctrl+I" data-mac-shortcut="鈱�+I" data-event="italic" tabindex="-1"><i class="fa fa-italic icon-italic"></i></button>';
            },
            underline: function (lang) {
                return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.font.underline + '" data-shortcut="Ctrl+U" data-mac-shortcut="鈱�+U" data-event="underline" tabindex="-1"><i class="fa fa-underline icon-underline"></i></button>';
            },
            clear: function (lang) {
                return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.font.clear + '" data-shortcut="Ctrl+\\" data-mac-shortcut="鈱�+\\" data-event="removeFormat" tabindex="-1"><i class="fa fa-eraser icon-eraser"></i></button>';
            },
            ul: function (lang) {
                return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.lists.unordered + '" data-shortcut="Ctrl+Shift+8" data-mac-shortcut="鈱�+鈬�+7" data-event="insertUnorderedList" tabindex="-1"><i class="fa fa-list-ul icon-list-ul"></i></button>';
            },
            ol: function (lang) {
                return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.lists.ordered + '" data-shortcut="Ctrl+Shift+7" data-mac-shortcut="鈱�+鈬�+8" data-event="insertOrderedList" tabindex="-1"><i class="fa fa-list-ol icon-list-ol"></i></button>';
            },
            paragraph: function (lang) {
                return '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="' + lang.paragraph.paragraph + '" data-toggle="dropdown" tabindex="-1"><i class="fa fa-align-left icon-align-left"></i>  <span class="caret"></span></button>' +
                    ...
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.paragraph.left + '" data-shortcut="Ctrl+Shift+L" data-mac-shortcut="鈱�+鈬�+L" data-event="justifyLeft" tabindex="-1"><i class="fa fa-align-left icon-align-left"></i></button>' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.paragraph.center + '" data-shortcut="Ctrl+Shift+E" data-mac-shortcut="鈱�+鈬�+E" data-event="justifyCenter" tabindex="-1"><i class="fa fa-align-center icon-align-center"></i></button>' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.paragraph.right + '" data-shortcut="Ctrl+Shift+R" data-mac-shortcut="鈱�+鈬�+R" data-event="justifyRight" tabindex="-1"><i class="fa fa-align-right icon-align-right"></i></button>' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.paragraph.justify + '" data-shortcut="Ctrl+Shift+J" data-mac-shortcut="鈱�+鈬�+J" data-event="justifyFull" tabindex="-1"><i class="fa fa-align-justify icon-align-justify"></i></button>' +
                    '</div>' +
                    '<div class="note-list btn-group">' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.paragraph.outdent + '" data-shortcut="Ctrl+[" data-mac-shortcut="鈱�+[" data-event="outdent" tabindex="-1"><i class="fa fa-outdent icon-indent-left"></i></button>' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.paragraph.indent + '" data-shortcut="Ctrl+]" data-mac-shortcut="鈱�+]" data-event="indent" tabindex="-1"><i class="fa fa-indent icon-indent-right"></i></button>' +
                    '</div>' +
                    '</div>';
            },
        ...
        var tplShortcutText = function (lang, options) {
            return '<table class="note-shortcut">' +
                ...
                '</thead>' +
                '<tbody>' +
                '<tr><td>鈱� + B</td><td>' + lang.font.bold + '</td></tr>' +
                '<tr><td>鈱� + I</td><td>' + lang.font.italic + '</td></tr>' +
                '<tr><td>鈱� + U</td><td>' + lang.font.underline + '</td></tr>' +
                '<tr><td>鈱� + 鈬� + S</td><td>' + lang.font.strike + '</td></tr>' +
                '<tr><td>鈱� + \\</td><td>' + lang.font.clear + '</td></tr>' +
                '</tr>' +
                '</tbody>' +
                '</table>';
        };
        ...
        var tplShortcutAction = function (lang, options) {
            return '<table class="note-shortcut">' +
                ...
                '</thead>' +
                '<tbody>' +
                '<tr><td>鈱� + Z</td><td>' + lang.history.undo + '</td></tr>' +
                '<tr><td>鈱� + 鈬� + Z</td><td>' + lang.history.redo + '</td></tr>' +
                '<tr><td>鈱� + ]</td><td>' + lang.paragraph.indent + '</td></tr>' +
                '<tr><td>鈱� + [</td><td>' + lang.paragraph.outdent + '</td></tr>' +
                '<tr><td>鈱� + ENTER</td><td>' + lang.hr.insert + '</td></tr>' +
                '</tbody>' +
                '</table>';
        };
        ...
        var tplShortcutPara = function (lang, options) {
            return '<table class="note-shortcut">' +
                ...
                '</thead>' +
                '<tbody>' +
                '<tr><td>鈱� + 鈬� + L</td><td>' + lang.paragraph.left + '</td></tr>' +
                '<tr><td>鈱� + 鈬� + E</td><td>' + lang.paragraph.center + '</td></tr>' +
                '<tr><td>鈱� + 鈬� + R</td><td>' + lang.paragraph.right + '</td></tr>' +
                '<tr><td>鈱� + 鈬� + J</td><td>' + lang.paragraph.justify + '</td></tr>' +
                '<tr><td>鈱� + 鈬� + NUM7</td><td>' + lang.lists.ordered + '</td></tr>' +
                '<tr><td>鈱� + 鈬� + NUM8</td><td>' + lang.lists.unordered + '</td></tr>' +
                '</tbody>' +
                '</table>';
        };
        ...
        var tplShortcutStyle = function (lang, options) {
            return '<table class="note-shortcut">' +
                ...
                '</thead>' +
                '<tbody>' +
                '<tr><td>鈱� + NUM0</td><td>' + lang.style.normal + '</td></tr>' +
                '<tr><td>鈱� + NUM1</td><td>' + lang.style.h1 + '</td></tr>' +
                '<tr><td>鈱� + NUM2</td><td>' + lang.style.h2 + '</td></tr>' +
                '<tr><td>鈱� + NUM3</td><td>' + lang.style.h3 + '</td></tr>' +
                '<tr><td>鈱� + NUM4</td><td>' + lang.style.h4 + '</td></tr>' +
                '<tr><td>鈱� + NUM5</td><td>' + lang.style.h5 + '</td></tr>' +
                '<tr><td>鈱� + NUM6</td><td>' + lang.style.h6 + '</td></tr>' +
                '</tbody>' +
                '</table>';
        };
        ...
        var replaceMacKeys = function (sHtml) {
            return sHtml.replace(/鈱�/g, 'Ctrl').replace(/鈬�/g, 'Shift');
        };
        ...
        tplDialog = function (lang, options) {
            ...
            var tplHelpDialog = function () {
                return '<div class="note-help-dialog modal" aria-hidden="false">' +
                    ...
                    '<p class="text-center"><a href="//hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.1</a> 路 <a href="//github.com/HackerWins/summernote" target="_blank">Project</a> 路 <a href="//github.com/HackerWins/summernote/issues" target="_blank">Issues</a></p>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>';
